...
export default function SpotlightCards({
  ...
  // Index keys avoid duplicate React keys when multiple cards share the same title
  // (e.g. dashboard stat cards whose title is the numeric count "0").
